...
public class ContextBootstrapInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("com.example.demo.Demo2Application", Demo2Application.class)
        .instanceSupplier(Demo2Application::new).register(beanFactory);
    BeanDefinitionRegistrar.of("defaultController", DefaultController.class)
        .instanceSupplier(DefaultController::new).register(beanFactory);
    com.example.demo.controller.ContextBootstrapInitializer.registerEstudianteController(beanFactory);
    com.example.demo.service.ContextBootstrapInitializer.registerEstudianteService(beanFactory);
    ...
    BeanDefinitionRegistrar.of("estudianteRepository", ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, EstudianteRepository.class, Estudiante.class, Integer.class)).withConstructor(Class.class)
      ...
      bd.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.example.demo.repository.EstudianteRepository");
